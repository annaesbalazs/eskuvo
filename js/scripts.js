$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            end: new Date('Sep 17, 2023 12:00'),

            // Event Address
            address: 'Balaton-felvidéki Erdészeti Erdei Iskola, Szentjakabfa 8272',

            // Event Description
            description: "Sok szeretettel várunk Titeket az esküvőnkön! Anna és Balázs"
        }
    });
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sajnálom!</strong> A meghívó kód helytelen.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbyo0rEknln8LedEP3bkONsfOh776IR5lFidLhJFQ6jdvRiH4dKvHZmtoIybvnxpxYr2cA/exec', data)
                ...
                .fail(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html(alert_markup('danger', '<strong>Sajnálom!</strong> Valami gond akadt a szerverrel. '));
                });
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 46.947463, lng: 17.650839};
